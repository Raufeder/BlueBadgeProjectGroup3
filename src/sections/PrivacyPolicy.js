...
const PrivacyPolicy = (props) => {
    ...
    return (
        <div className="privacyPolicy">
            <h3>Privacy Policy of https://heroku.oursite.org</h3>
            ...
            <p>We only use your personal information to provide you the Personary services or to communicate with you about the Website or the services.</p>
