  ...
  return (
    <div className="App">
      {isLoggedIn === false ? (
        <>
          <div className="logo">
            <img className="logoPic" src={logo} alt="personary logo" />
          </div>
          <div className="headline">
            <h1 className="mainHeadline">Create Characters. Plan Personas.</h1>
          </div>
          <div className="subHead">
            <p>
              Create, edit, and save all of your character's personas in one
              easy-to-use tool.
            </p>
          </div>
        </>
      ...
      <Router>
        ...
        <Switch>
          ...
          <Route exact path="/createnewcharacter" key="createRoute">
            <div className="pageContainer">
              <CreateCharacter mode={"Create"} />
            </div>
          </Route>
          <Route path="/viewcharacter/:id" key="viewRoute">
            <div className="pageContainer">
              <CreateCharacter mode={"View"} characterList={characterList} />
            </div>
          </Route>
