...
// CharEyeColo... basic eye color based on general population percentage, specific color within is random
  ...
  let CharEyeColor = getRandomValueFromTuples(eyeColorTuples);  // THIS IS THE RANDOM EYE COLOR
...
let CharBodyType = bodyDescriptorList[rollBodyDescriptorList];  // THIS IS THE RANDOM BODY DESCRIPTOR
...
let CharPersonalityPolarOpp = polarOppositesList[rollPolarOpposites];  // THIS IS THE RANDOM POLOR OPPOSITE DESCRIPTOR
...
let CharPersonalityDescriptor = personalityDescriptorsList[rollpersonalityDescriptorsList];  // THIS IS THE RANDOM PERSONALITY DESCRIPTOR
...
let CharPersonalityQuirk = personalityQuirksList[rollPersonalityQuirksList];  // THIS IS THE RANDOM PERSONALITY QUIRK
console.log("Personality quirk:", personalityQuirksListRndChoice);
console.log("___________________________________________");
...
if (canBeMarried > 0) {
  CharRelationshipStatus = getRandomValueFromTuples(relationshipStatusTuples);  // THIS IS THE RELATIONSHIP STATUS or
} else {
  CharRelationshipStatus = "single";  // THIS IS THE RELATIONSHIP STATUS
};
